...
echo "  level 16"
echo ""
render_list -a -m br -s /var/run/renderd/renderd.sock -n 3 -t /data/tiles/ -z 16 -Z 16 -x 31832 -X 32541 -y 22544 -Y 23036
date
echo ""
...
echo "  level 17"
echo ""
render_list -a -m br -s /var/run/renderd/renderd.sock -n 3 -t /data/tiles/ -z 17 -Z 17 -x 63664 -X 65081 -y 45087 -Y 46071
date
echo ""
